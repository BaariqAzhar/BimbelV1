...
public class EfActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng go = new LatLng(-7.9659844,112.6235223);
        mMap.addMarker(new MarkerOptions().position(go).title("English First"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONObject bimbel = obj.getJSONObject("ef");
