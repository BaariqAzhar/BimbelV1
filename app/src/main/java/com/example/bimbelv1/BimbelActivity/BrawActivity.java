...
public class BrawActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_braw);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng go = new LatLng(-7.949905,112.6177152);
        mMap.addMarker(new MarkerOptions().position(go).title("Brawijaya Study Club"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONObject bimbel = obj.getJSONObject("braw");
