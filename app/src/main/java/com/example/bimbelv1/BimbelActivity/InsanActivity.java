...
public class InsanActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng go = new LatLng(-7.9495202,112.4863807);
        mMap.addMarker(new MarkerOptions().position(go).title("Insan Madani Institute"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONObject bimbel = obj.getJSONObject("insan");
