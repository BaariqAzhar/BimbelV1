...
public class NurulActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng go = new LatLng(-7.9622358,112.6217412);
        mMap.addMarker(new MarkerOptions().position(go).title("Nurul Fikri"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONObject bimbel = obj.getJSONObject("nurul");
